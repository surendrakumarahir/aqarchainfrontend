...
const Profile = () => {
	...
	return (
		<DashboardComponent>
			<div className={`tab-pane ${!editProfile?"my-profile-view": ""} show active`} id="company-nav-tab-my-profile" role="tabpanel" aria-labelledby="company-nav-tab-my-profile-tab">
				<div className="text-lg-left p-4 p-lg-5 has-box-shadow has-border-radius">
					<div className="row d-lg-flex align-items-center">
						...
						<div className="col-lg-6 col-12 text-right">
							<div className={`edit-button ${editProfile?"d-none":""}`} id="edit-profile-btn" 
					...
					<div className="row my-3">
						<div className="col-lg-4 col-md-6 col-12">
							<button className={`btn btn-gradient-secondary ${!editProfile ? "d-none": ""} w-100`} id="save-profile-btn" 
								onClick={toggleProfileView}
							>Save</button>
						</div>
					</div>
